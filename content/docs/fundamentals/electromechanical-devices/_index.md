...
- **[Relays]({{< relref "relays" >}})** — Electromagnetic relays: coil drive, contact ratings, bounce, flyback protection, and when to choose them over solid-state switches.
- **[Reed Switches]({{< relref "reed-switches" >}})** — Magnetically actuated contacts in a sealed glass envelope: sensing, low-level switching, and their unique failure modes.
- **[Contactors]({{< relref "contactors" >}})** — Heavy-duty relays for high-power loads: motor control, mains switching, and arc suppression at scale.
- **[Speakers & Buzzers]({{< relref "speakers-and-buzzers" >}})** — Dynamic speakers, piezoelectric elements, and electromagnetic buzzers: drive requirements, impedance, and acoustic behavior.
